/*
* @Author: Polylanger
* @Date:   2018-04-11 14:53:13
* @Last Modified by:   Polylanger
* @Last Modified time: 2018-04-11 15:30:48
*/
'use strict';
...
var addressModal = {
        ...
        this.$modalWrap.find('.address-btn').click(function(){
            ...
            var receiverInfo = _this.getReceiverInfo(),
                ...
                if(!isUpdate && receiverInfo.status){
                    ...
                    _apec.errorTips(receiverInfo.errMsg || '发送了错误');
                }
        });
    ...
    loadModal : function(){
        var addressModalHtml = _apec.renderHtml(templateIndex,{
